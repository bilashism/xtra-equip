...
const FeaturedBlogPosts = () => {
  return (
    <div class="flex flex-col md:flex-row justify-around m-2 items-center h-full rounded-2xl bg-gradient-to-l from-rose-400 via-fuchsia-500 to-indigo-500">
      <div className="container-default xl:grid xl:grid-cols-12 xl:items-center gap-12 xl:gap-8">
        <div class="xl:col-span-4 flex flex-col gap-8 items-center  text-white">
          <h2 class="text-3xl md:text-7xl font-bold text-center xl:text-left">
        ...
        <div class="xl:col-span-8  overflow-hidden flex flex-col md:flex-row justify-center">
          <div class="overflow-hidden md:w-1/4 bg-white m-4 shadow-lg flex flex-col text-black hover:text-white hover:bg-pink-500 hover:scale-105 rounded cursor-pointer">
            ...
            <div class="text-sm m-2">30 July, 2022</div>
